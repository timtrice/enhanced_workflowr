...
Please see [SUPPORT](https://github.com/timtrice/enhanced_workflowr/blob/master/.github/SUPPORT.md) if you should find any discrepancies in this project.
...
## Authors
  ...
  * **`r getOption("usethis.full_name")`** - *Initial work* - [timtrice](https://github.com/timtrice)

See also the list of [contributors](https://github.com/timtrice/enhanced_workflowr/contributors) who participated in this project.
