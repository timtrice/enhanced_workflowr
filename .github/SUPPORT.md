# Getting help with enhanced_workflowr

Thanks for using enhanced_workflowr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/timtrice/enhanced_workflowr/issues) to make sure the 
